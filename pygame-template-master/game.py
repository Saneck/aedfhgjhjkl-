...
class Game:
    ...
    def new(self):
        ...
        self.weapons.add(Weapon(13, 5, 450, "pistol", "img\\sprites\\pistolRIGHT.png", self.player))
        self.weapons.add(Weapon(70, 12, 900, "sniper", "img\\sprites\\awpRIGHT.png", self.player))
        self.weapons.add(Weapon(30, 9, 200, "akm", "img\\sprites\\akmRIGHT.png", self.player))
